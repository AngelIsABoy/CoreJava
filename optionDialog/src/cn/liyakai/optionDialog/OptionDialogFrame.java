...
public class OptionDialogFrame extends JFrame{
	...
	public OptionDialogFrame(){
		...
		typePanel = new ButtonPanel("Type", "Message", "Confirm", "Input");
		...
		optionTypePanel = new ButtonPanel("Confirm", "DEFAULT_OPTION", "YES_NO_OPTION", "YES_NO_CALCEL_OPTION", "OK_CANCEL_OPTION");
	 ...
	 *@return a string, cion, component, or object array, depending on Message panel selection 
	 * */
	...
	/*
	 * The action listener for the Show button shows a Confirm, Input, Message, or Option dislog
